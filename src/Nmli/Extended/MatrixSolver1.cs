...
{
    /// <summary>
    /// Exposes methods to solve equations of the form A.X.A^t = B for X.
    /// </summary>
    public class MatrixSolver1<N> : ExtendingFunc<N>
    {
        ...
        /// <summary>
        /// Solves the equation A.X.A^t = 1 for X, with X square, 1 = identity matrix,
        /// and rows(A) >= cols(A)
        /// </summary>
        ...
        public void Solve1(int ra, int ca, N[] A, N[] X)
        {
            // A: ra x ca
            // Id: ra x ra
            // X: ca x ca
