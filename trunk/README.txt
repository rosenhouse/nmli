...
For a simple example use-case, see Nmli.Extended.Vectorized2DNormalPDF<N>.AddConstantPairwise()


Also, polymorphism over collection types:  
With everything implementing the same interfaces, we end up abstracting out 
...
The issue is should it be a static, compile time check, or a runtime one? 
